<template>
  <div>
    <footer class="bg-gray-100 w-full flex px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-4 xl:py-6">
      <div class="w-full pt-10 pb-6">
        ...
        <div class="flex flex-wrap items-center md:justify-between justify-center">
          <div class="w-full md:w-4/12 px-4 mx-auto text-center mt-4">
            <div class="text-sm text-gray-600 font-semibold py-1">
              Copyright © 2020 by
              <a
                href="https://whaally.com"
